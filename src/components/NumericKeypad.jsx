      ...
      >
        ...
        <div className="p-4">
          <div className="grid grid-cols-4 gap-2">
            ...
            <button onClick={() => handleKeyPress('-')} className="p-5 text-2xl font-bold bg-slate-200 hover:bg-slate-300 active:bg-slate-400 rounded-xl transition-colors">-</button>
            ...
            {/* Row 4 */}
            <button onClick={() => handleKeyPress('0')} className="p-5 col-span-3 text-2xl font-bold bg-slate-100 hover:bg-slate-200 active:bg-slate-300 rounded-xl transition-colors">0</button>
          </div>
        </div>
      </div>
    </div>
